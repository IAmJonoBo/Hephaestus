...
def sanitize_path(
    root: Path, *, dry_run: bool = False, set_copyfile_disable: bool = True
) -> SanitizationReport:
    ...
    Args:
        ...
        set_copyfile_disable: If True, sets the COPYFILE_DISABLE environment variable
            to prevent macOS from recreating resource fork files during copy operations.
    """

    if set_copyfile_disable:
