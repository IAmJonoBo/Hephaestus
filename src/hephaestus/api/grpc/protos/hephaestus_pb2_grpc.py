...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in hephaestus_pb2_grpc.py depends on"
...
class QualityServiceServicer:
    """Quality Service - Execute quality gates and checks"""

    def RunGuardRails(self, _request, context: grpc.ServicerContext):
        """Run guard-rails quality pipeline (blocking)"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details(_NOT_IMPLEMENTED)
        raise NotImplementedError(_NOT_IMPLEMENTED)

    def RunGuardRailsStream(self, _request, context: grpc.ServicerContext):
        """Run guard-rails with streaming progress updates"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details(_NOT_IMPLEMENTED)
        raise NotImplementedError(_NOT_IMPLEMENTED)

    def CheckDrift(self, _request, context: grpc.ServicerContext):
...
def add_QualityServiceServicer_to_server(servicer: QualityServiceServicer, server: grpc.Server):
    rpc_method_handlers = {
...
class CleanupServiceServicer:
    """Cleanup Service - Workspace cleanup operations"""

    def Clean(self, _request, context: grpc.ServicerContext):
        """Execute cleanup operation"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details(_NOT_IMPLEMENTED)
        raise NotImplementedError(_NOT_IMPLEMENTED)

    def PreviewCleanup(self, _request, context: grpc.ServicerContext):
...
def add_CleanupServiceServicer_to_server(servicer: CleanupServiceServicer, server: grpc.Server):
    rpc_method_handlers = {
...
class AnalyticsServiceServicer:
    ...
    def GetRankings(self, _request, context: grpc.ServicerContext):
        """Get refactoring rankings"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details(_NOT_IMPLEMENTED)
        raise NotImplementedError(_NOT_IMPLEMENTED)

    def GetHotspots(self, _request, context: grpc.ServicerContext):
        """Get code hotspots"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details(_NOT_IMPLEMENTED)
        raise NotImplementedError(_NOT_IMPLEMENTED)
