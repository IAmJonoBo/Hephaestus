...
const API_REF_PATH = resolve(
  ROOT,
  "src/content/docs/reference/api-generated.md",
);
...
function generateApiDoc() {
  ...
  doc.push(
    "This page is automatically generated from Python docstrings and type annotations.",
  );
  ...
  doc.push("");
  doc.push(
    "The Hephaestus Python API provides programmatic access to all toolkit functionality.",
  );
  doc.push("");
  doc.push(
    "For REST API documentation, see [REST API Reference](/reference/api/).",
  );
  doc.push("");
